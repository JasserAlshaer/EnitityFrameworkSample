    ...
    public partial class start4 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientClinic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientClinic_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientClinic_Paitents_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientClinic_ClinicId",
                table: "PatientClinic",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientClinic_PatientId",
                table: "PatientClinic",
                column: "PatientId");
        }
